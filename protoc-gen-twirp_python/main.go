...
func (g *generator) generateProtobufClient(file *descriptor.FileDescriptorProto, service *descriptor.ServiceDescriptorProto) {
	...
	g.P()
	g.P(`    def __init__(self, server_address, headers_provider=None, request_hook=None, response_hook=None, verify=True):`)
	...
	g.P(`            verify: bool. Enable (=True) / Disable (=False) SSL certificate verification. Defaults to True`)
	g.P(`        """`)
